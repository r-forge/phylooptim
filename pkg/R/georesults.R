...
load("/home/michels/repository/phylooptim/pkg/R/geiger/geogeigererror.RData")
geiger <- l
l <- NULL
...
load("/home/michels/repository/phylooptim/pkg/R/ace/geoaceerror.RData")
ace <- l
l <- NULL
...
load("/home/michels/repository/phylooptim/pkg/R/ouch/geooucherror.RData")
ouch <- l
l <- NULL
