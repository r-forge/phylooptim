...
text((2.5+3.5)/2,9.5,"default",col="white",cex=2)
text((6.5+.25+7.5+.25)/2,1.5,"default",col="white",cex=2)
text((10.5+.5+11.5+.5)/2,1.5,"default",col="black",cex=2)
text((14.5+.75+15.5+.75)/2,8.5,"default",col="white",cex=2)
dev.off()
