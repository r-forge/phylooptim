...
#This way has x and y flipped

propnew <- matrix(NA,ncol=12,nrow=16)
for (k in c(1:4)){
  for (i in c(1:12)){
    for (j in c(1:4)){
if (k==1){propnew[j,i] <- prop[[k]][j,i+1]}
if (k==2){propnew[4+j,i] <- prop[[k]][j,i+1]}
if (k==3){propnew[8+j,i] <- prop[[k]][j,i+1]}
if (k==4){propnew[12+j,i] <- prop[[k]][j,i+1]}
    }
  }
}

png("propplot.png")
plot(x=c(-1,12),y=c(0,17.75),type="n",axes=FALSE,xlab="",ylab="",main="Proportion Correct")
for (y in c(1:4)) {
  for (x in c(1:12))  {
...
text(1, 10.5, "spg",cex = .8,pos=2)
text(1, 9.5, "Rcgmin",cex = .8,pos=2)
text(1, 8.5, "Rvmmin",cex = .8,pos=2)
text(1, 7.5, "bobyqa",cex = .8,pos=2)
text(1, 6.5, "L-BFGS-B",cex = .8,pos=2)
text(1, 5.5, "nlminb",cex = .8,pos=2)
text(1, 4.5, "ucminf",cex = .8,pos=2)
text(1, 3.5, "Nelder-Mead",cex = .8,pos=2)
text(1, 2.5, "nlm",cex = .8,pos=2)
text(1, 1.5, "CG",cex = .8,pos=2)
text(1, 0.5, "BFGS",cex = .8,pos=2)
text(1, -0.5, "newuoa",cex = .8,pos=2)

text(1.5, 11.25, "Geo",cex = .8,srt=90,pos=3)
text(2.5, 11.25, "Aqui",cex = .8,srt=90,pos=3)
text(3.5, 11.3, "Mono",cex = .8,srt=90,pos=3)
text(4.5, 11.25, "Mam",cex = .8,srt=90,pos=3)

text(5.5+.25, 11.25, "Geo",cex = .8,srt=90,pos=3)
text(6.5+.25, 11.25, "Aqui",cex = .8,srt=90,pos=3)
text(7.5+.25, 11.3, "Mono",cex = .8,srt=90,pos=3)
text(8.5+.25, 11.25, "Mam",cex = .8,srt=90,pos=3)

text(9.5+.5, 11.25, "Geo",cex = .8,srt=90,pos=3)
text(10.5+.5, 11.25, "Aqui",cex = .8,srt=90,pos=3)
text(11.5+.5, 11.3, "Mono",cex = .8,srt=90,pos=3)
text(12.5+.5, 11.25, "Mam",cex = .8,srt=90,pos=3)

text(13.5+.75, 11.25, "Geo",cex = .8,srt=90,pos=3)
text(14.5+.75, 11.25, "Aqui",cex = .8,srt=90,pos=3)
text(15.5+.75, 11.3, "Mono",cex = .8,srt=90,pos=3)
text(16.5+.75, 11.25, "Mam",cex = .8,srt=90,pos=3)
