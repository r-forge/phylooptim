...
\begin{center}
\setkeys{Gin}{width=.23\textwidth}
{\fs
<<contourspg, echo=FALSE, fig=TRUE, eps = FALSE, height=4, width=4>>=
j <- 1
...
\setkeys{Gin}{width=.23\textwidth}
{\fs
<<contourRcgmin, echo=FALSE, fig=TRUE, eps = FALSE, height=4, width=4>>=
j <- 2
filled.contour2(x1range,x2range,res,levels=lev,col=cols,axes=FALSE,
      		plot.axes={
                  axis(side = 1, at = x.labels,labels=x.labels)
...
\setkeys{Gin}{width=.23\textwidth}
{\fs
<<contourRvmmin, echo=FALSE, fig=TRUE, eps = FALSE, height=4, width=4>>=
j <- 3
filled.contour2(x1range,x2range,res,levels=lev,col=cols,axes=FALSE,
      		plot.axes={
                  axis(side = 1, at = x.labels,labels=x.labels)
...
\setkeys{Gin}{width=.23\textwidth}
{\fs
<<contourbobyqa, echo=FALSE, fig=TRUE, eps = FALSE, height=4, width=4>>=
j <- 4
filled.contour2(x1range,x2range,res,levels=lev,col=cols,axes=FALSE,
      		plot.axes={
                  axis(side = 1, at = x.labels,labels=x.labels)
...
\setkeys{Gin}{width=.23\textwidth}
{\fs
<<contourL-BFGS-B, echo=FALSE, fig=TRUE, eps = FALSE, height=4, width=4>>=
j <- 5
filled.contour2(x1range,x2range,res,levels=lev,col=cols,axes=FALSE,
      		plot.axes={
                  axis(side = 1, at = x.labels,labels=x.labels)
...
\setkeys{Gin}{width=.23\textwidth}
{\fs
<<contournlminb, echo=FALSE, fig=TRUE, eps = FALSE, height=4, width=4>>=
j <- 6
filled.contour2(x1range,x2range,res,levels=lev,col=cols,axes=FALSE,
      		plot.axes={
                  axis(side = 1, at = x.labels,labels=x.labels)
...
\setkeys{Gin}{width=.23\textwidth}
{\fs
<<contourucminf, echo=FALSE, fig=TRUE, eps = FALSE, height=4, width=4>>=
j <- 7
filled.contour2(x1range,x2range,res,levels=lev,col=cols,axes=FALSE,
      		plot.axes={
                  axis(side = 1, at = x.labels,labels=x.labels)
...
\setkeys{Gin}{width=.23\textwidth}
{\fs
<<contourN-M, echo=FALSE, fig=TRUE, eps = FALSE, height=4, width=4>>=
j <- 8
filled.contour2(x1range,x2range,res,levels=lev,col=cols,axes=FALSE,
      		plot.axes={
                  axis(side = 1, at = x.labels,labels=x.labels)
...
\setkeys{Gin}{width=.23\textwidth}
{\fs
<<contournlm, echo=FALSE, fig=TRUE, eps = FALSE, height=4, width=4>>=
j <- 9
filled.contour2(x1range,x2range,res,levels=lev,col=cols,axes=FALSE,
      		plot.axes={
                  axis(side = 1, at = x.labels,labels=x.labels)
...
\setkeys{Gin}{width=.23\textwidth}
{\fs
<<contourCG, echo=FALSE, fig=TRUE, eps = FALSE, height=4, width=4>>=
j <- 10
filled.contour2(x1range,x2range,res,levels=lev,col=cols,axes=FALSE,
      		plot.axes={
                  axis(side = 1, at = x.labels,labels=x.labels)
...
\setkeys{Gin}{width=.23\textwidth}
{\fs
<<contourBFGS, echo=FALSE, fig=TRUE, eps = FALSE, height=4, width=4>>=
j <- 11
filled.contour2(x1range,x2range,res,levels=lev,col=cols,axes=FALSE,
      		plot.axes={
                  axis(side = 1, at = x.labels,labels=x.labels)
...
\setkeys{Gin}{width=.23\textwidth}
{\fs
<<contournewuoa, echo=FALSE, fig=TRUE, eps = FALSE, height=4, width=4>>=
j <- 12
filled.contour2(x1range,x2range,res,levels=lev,col=cols,axes=FALSE,
      		plot.axes={
                  axis(side = 1, at = x.labels,labels=x.labels)
